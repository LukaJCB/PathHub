...
export const FollowRequestsView: React.FC = () => {
    ...
    async function handleSubmitFollowRequest(e: FormEvent) {
        ...
        if (userInfo) {
            ...
            const newFollowRequests = await requestFollow(createCredential(user.id), userInfo.userid, getKeyPairFromGroupState(user.ownGroupState), user.followRequests, 
                                    ...
                                    {user.followRequests.outgoing.map(i => (
                                        <div key={i.followeeId} className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                                            ...
                                            >
                                                ...
                                                <div>
                                                    <span className="font-medium text-gray-900 block">{usernames.get(i.followeeId) || i.followeeId}</span>
