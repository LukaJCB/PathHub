...
const MapLibreRouteMap: React.FC<Props> = ({ route, showMarkers = true, width = "100%", height = "500px" }) => {
  ...
  useEffect(() => {
    ...
    map.on("load", () => {
      ...
      if (showMarkers) {
        ...
        new maplibregl.Marker().setLngLat(coordinates[coordinates.length - 1]!).addTo(map)
      }
