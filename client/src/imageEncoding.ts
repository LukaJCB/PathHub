export function encodeBlobWithMime(imageBuffer: ArrayBuffer, mimeType: string): Uint8Array {
  ...
  const payload = new Uint8Array(2 + mimeBytes.length + imageBuffer.byteLength)
...
export function decodeBlobWithMime(payload: Uint8Array): { mimeType: string; bytes: Uint8Array } {
